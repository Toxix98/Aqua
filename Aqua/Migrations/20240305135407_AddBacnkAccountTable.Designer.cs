...
namespace Aqua.Migrations
{
    ...
    [Migration("20240305135407_AddBacnkAccountTable")]
    partial class AddBacnkAccountTable
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Aqua.MVVM.Models.BankAccount", b =>
                {
                    ...
                    b.Property<string>("HaseBankChek")
                        .IsRequired()
                        .HasMaxLength(20)
            ...
            modelBuilder.Entity("Aqua.MVVM.Models.PurchaseInvoice", b =>
                {
                    ...
                    b.Property<string>("SearchDatePurchaseInvoice")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
            ...
            modelBuilder.Entity("Aqua.MVVM.Models.invoices", b =>
                {
                    ...
                    b.Property<string>("SearchDateInvoice")
                        .IsRequired()
                        .HasMaxLength(150)
                        .HasColumnType("nvarchar(150)");
